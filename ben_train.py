...
from ben_input import extract_data, resize_with_pad, IMAGE_SIZE
...
class Dataset(object):
    ...
    def read(self, img_rows=IMAGE_SIZE, img_cols=IMAGE_SIZE, img_channels=3, nb_classes=2):
        images, labels = extract_data('./train_data/')
...
class Model(object):
    ...
    def train(self, dataset, batch_size=10, nb_epoch=40, data_augmentation=True):
        ...
        if not data_augmentation:
            ...
            # fit the model on the batches generated by datagen.flow() 생성기
...
if __name__ == '__main__':
    ...
    model.train(dataset, nb_epoch= 3)
    model.save()
